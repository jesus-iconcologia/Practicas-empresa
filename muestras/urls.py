...
urlpatterns = [
    ...
    path('muestras/materiales', views.materiales_todos, name='materiales_todos'),
    path('muestras/materiales/', views.materiales_todos),
    path('muestras/materiales/acciones', views.acciones_materiales, name='acciones_materiales'),
    path('muestras/materiales/acciones/', views.acciones_materiales),
    path('muestras/materiales/excel', views.upload_excel_materiales, name='upload_excel_materiales'),
    path('muestras/materiales/excel/', views.upload_excel_materiales),
    path('muestras/materiales/excel/plantilla', views.descargar_plantilla_materiales, name='descargar_plantilla_materiales'),
    path('muestras/materiales/excel/plantilla/', views.descargar_plantilla_materiales),
    path('muestras/materiales/nuevo', views.nuevo_material, name='nuevo_material'),
    path('muestras/materiales/nuevo/', views.nuevo_material),
    path('muestras/materiales/<int:material_id>/editar', views.editar_material, name='editar_material'),
    path('muestras/materiales/<int:material_id>/editar/', views.editar_material),
    path('muestras/materiales/<int:material_id>/eliminar', views.eliminar_material, name='eliminar_material'),
    path('muestras/materiales/<int:material_id>/eliminar/', views.eliminar_material),
    ...
    path('muestras/upload_excel/plantilla/<str:import_mode>', views.descargar_plantilla_importacion_muestras, name='descargar_plantilla_importacion_muestras'),
    ...
    path('archivo/detalles_congelador/<str:nombre_congelador>/crear_posiciones', views.opciones_creacion_localizaciones, name='opciones_creacion_localizaciones'),
    path('archivo/detalles_congelador/<str:nombre_congelador>/crear_posiciones/formulario', views.crear_localizacion_manual, name='crear_localizacion_manual'),
    path('archivo/detalles_congelador/<str:nombre_congelador>/reparaciones/nueva', views.anadir_reparacion_recurso, name='anadir_reparacion_recurso'),
    path('archivo/reparaciones/<int:reparacion_id>/editar', views.editar_reparacion_recurso, name='editar_reparacion_recurso'),
    path('archivo/reparaciones/<int:reparacion_id>/eliminar', views.eliminar_reparacion_recurso, name='eliminar_reparacion_recurso'),
    path('archivo/crear_recurso', views.crear_recurso_congelador, name='crear_recurso_congelador'),
    path('archivo/plantilla_recurso/<int:congelador_id>', views.descargar_plantilla_localizaciones_recurso, name='descargar_plantilla_localizaciones_recurso'),
    ...
    path('estudios/documentos/descargar_seleccionados', views.descargar_documentos_seleccionados, name="descargar_documentos_seleccionados"),
    ...
    path('api/get_bandejas_por_rack/', views.get_bandejas_por_rack, name='get_bandejas_por_rack'),
    path('api/get_cajas_por_rack/', views.get_cajas_por_rack, name='get_cajas_por_rack'),
    path('api/get_cajas_por_bandeja/', views.get_cajas_por_bandeja, name='get_cajas_por_bandeja'),
